...
class sandy.math.IntersectionMath
{
	...
	{
		var res:Array = [ new Vector( 0.5 * ( p_oPointA.x + p_oPointB.x ), 0.5 * ( p_oPointA.y + p_oPointB.y ), 0.5 * ( p_oPointA.z + p_oPointB.z ) ),
	...
	{
		var	xA:Number = p_oPointA.x, yA:Number = p_oPointA.y,
