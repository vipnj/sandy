...
class sandy.skin.BasicSkin extends EventBroadcaster
{
	 ...
	 */
	public static var onUpdateEVENT:EventType = SkinEvent.UPDATE;
	...
	*/
	...
	{
		super( this );
		_eOnUpdate 	= new SkinEvent( SkinEvent.UPDATE, this, getType() );
		_filters 	= [];
		_useLight 	= false;
		_id = _ID_++;
	...
	{
		World3D.getInstance().light.addEventListener( Light3D.onLightUpdatedType, this, __onLightUpdated );
	}
