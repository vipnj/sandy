package examples
{
	...
	public class LineExample extends BasicExample
	{
		private var line:Object3D;
		...
		private function createScene( bg:Group ):void
		{
			...
			{
				var p:Vector = new Vector( int(Math.random()*200), int(Math.random()*200), int(Math.random()*200) );
				points.push(p);
			}
