package  {
	...
	public class Thingy extends Shape3D implements Primitive3D {
		...
		public function Thingy( p_Name:String=null ) {
			super( p_Name );
			geometry = generate();
		}
		...
		public function generate(... arguments):Geometry3D {
			l = new Geometry3D();
			v(1.000000,1.007194,-0.500972);
			v(1.000000,-1.000000,-0.333333);
			v(1.000000,-1.000000,0.333333);
			v(-1.000000,1.007194,-0.500972);
			v(-1.000000,-1.000000,-0.333333);
			v(-1.000000,-1.000000,0.333333);
			v(1.000000,1.007193,0.510757);
			v(-1.000000,1.007194,0.510757);
			v(1.000000,0.606014,-0.333333);
			v(1.000000,0.606014,0.333333);
			v(0.333333,-1.000000,-0.333333);
			v(0.333333,-1.000000,0.333333);
			v(-0.333334,-1.000000,-0.333333);
			v(-0.333334,-1.000000,0.333333);
			v(-1.000000,0.606014,-0.333333);
			v(-1.000000,0.606014,0.333333);
			v(-0.333334,-0.333333,0.334111);
			v(0.333333,-0.334111,0.333333);
			v(-0.333333,-0.333333,-0.334111);
			v(0.333333,-0.333333,-0.334111);
			v(1.495717,0.606014,-0.333333);
			v(1.495717,0.606013,0.333333);
			v(-1.488318,0.606014,-0.333333);
			v(-1.488318,0.606014,0.333333);
			v(0.111111,-0.334111,-0.111111);
			v(0.111111,-0.334111,0.111111);
			v(-0.111111,-0.334111,-0.111111);
			v(-0.111111,-0.334111,0.111111);
			v(-0.111111,-1.195669,-0.111111);
			v(0.111111,-1.195669,-0.111111);
			v(-0.111112,-1.195669,0.111111);
			v(0.111111,-1.195669,0.111111);
			v(-1.488318,1.007194,-0.333333);
			v(-1.488318,1.007194,0.333333);
			v(-1.000000,1.007194,0.333333);
			v(-1.000000,1.007194,-0.333333);
			v(1.000000,1.007193,0.333333);
			v(1.495717,1.007193,0.333333);
			v(1.495717,1.007193,-0.333333);
			v(1.000000,1.007193,-0.333333);
