...
{
	function getUVCoords(Void):Array;
	
	function setUVCoordsId( p_id:Number):Void;
	...
	*/
	function createNormale(Void):Vector;
	...
	*/
	function setNormalId( n:Number):Void;
	...
	* @return	The Skin of the Face
	*/
	function getBackSkin(Void):Skin;
	...
	*/
	function getZAverage(Void):Number;
	 ...
	 */
	function getMinDepth (Void):Number;
	 ...
	 */
	function getMaxDepth (Void):Number;
	...
	* @param	Void
	*/
	function swapCulling(Void):Void;
	...
	*/
	function getVertices(Void):Array;
	
	function getClippedVertices(Void):Array;
	
	/**
	* Destroy the face instance and remove all the event it was listening.
	*/
	function destroy(Void):Void;
}
