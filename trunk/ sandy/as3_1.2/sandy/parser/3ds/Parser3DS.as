package sandy.util.3ds 
{
	...
	public class Parser3DS extends Parser
	{
		...
		override protected function parseData(p_event:Event):void
		{
			...
			var currentHierarchyId:int = -1;
			var f:Polygon;
			var g:Geometry3D = new Geometry3D();	
			var scene:Group	= _rootNode;
			var lCurrentObject:Object3D;
			...
			while(data.bytesAvailable > 0)
			{
				...
				switch(id)
				{
				    ...
				    case Parser3DSChunkTypes.EDIT_OBJECT:
			            ...
			            lCurrentObject = new Object3D(str, g);
					...
					case Parser3DSChunkTypes.OBJ_TRIMESH:
			         ...
			         case Parser3DSChunkTypes.TRI_FACEL1:		// faces
			            ...
			            for (i = 0; i<l_qty; i++)
			            {
			            	...
			            	g.createFaceByIds( vertex_a, vertex_b, vertex_c );
			            }
			         ...
			         case Parser3DSChunkTypes.TRI_LOCAL:		//ParseLocalCoordinateSystem
						...
						lCurrentObject.transform.matrix = init_m;
			         ...
			         case Parser3DSChunkTypes.NODE_HDR:
			         	...
			         	var hierarchy:int = data.readShort();
			         	
			         	if( hierarchy > currentHierarchyId )
			         	{
			         		;
			         	}
