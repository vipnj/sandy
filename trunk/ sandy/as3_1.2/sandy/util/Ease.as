 ...
 */
 ...
 package sandy.util {
	...
	{	
		 ...
		 * @return The current Ease instance
		 */
		public function easingOutToBackOut(a:Number = 1, c:Number = .25):Ease 
		{
		 ...
		 * @return The current Ease instance
		 */
		public function easingOutToBackIn(a:Number = 1, c:Number = .25):Ease 
		{
		 ...
		 * @return The current Ease instance
		 */
		public function bounce(b:Number = 1, r:Number = 1, e:Object = null):Ease 
