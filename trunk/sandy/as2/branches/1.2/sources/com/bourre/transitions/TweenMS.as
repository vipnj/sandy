 ...
 */
 ...
 /**
 * {@code TweenMS} extends {@link BasicTweenMS} class implementing
 * Pixlib Event API.
 * 
...
class com.bourre.transitions.TweenMS extends BasicTweenMS 
	implements ITween
{
	//-------------------------------------------------------------------------
	// Events definition
	 ...
	 * @param nMs 	Length of time of the motion in milliseconds.
	 * @param nS 	(optional) Starting value of property.
	 * @param fE 	(optional) Easing function.
	*/
	public function TweenMS(oT, sP, nEnd:Number, nMs:Number, nStart:Number, fE:Function)
	{
		super(oT, sP, nEnd, nMs, nStart, fE);
