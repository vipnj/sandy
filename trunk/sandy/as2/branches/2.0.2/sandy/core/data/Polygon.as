...
// STATICS_______________________________________________________
	 ...
	 * <listing version="3.0">
	 * var p:Polygon = Polygon.POLYGON_MAP.get( myPolygon.id );
	 * </listing>
	 */
	public static var POLYGON_MAP:Map;
// ______
// PUBLIC________________________________________________________
	...
	{ 
		...
		m_oEB.broadcastEvent( new Shape3DEvent( p_oEvt, shape, this, l_oUV, l_oPt3d ) );
	}
	...
	private function _startMouseInteraction( e:EventType ) : Void
	{
		...
		container.keyDown = Delegate.create( this, _onTextureInteraction, KeyboardEvent.KEY_DOWN ); 
		container.keyUp = Delegate.create( this, _onTextureInteraction, KeyboardEvent.KEY_UP ); 
