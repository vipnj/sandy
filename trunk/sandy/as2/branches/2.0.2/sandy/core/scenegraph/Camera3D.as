...
{		
	...
	public function renderDisplayList( p_oScene:Scene3D ) : Void
	{
		...
		{
			m_aDisplayList[l_oShape].display( p_oScene );
			l_mcContainer.addChild( m_aDisplayList[l_oShape].container );
		}
		// -- back to low quality
   ...
   public function addArrayToDisplayList( p_aShapeArray:Array  ) : Void
   {
	...
	public function projectArray( p_oList:Array ) : Void
	{
		...
		{
			if( !p_oList[l_oVertex].projected )
			{
				...
				//nbVertices += 1;
				p_oList[l_oVertex].projected = true;
			}
