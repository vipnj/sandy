...
class sandy.math.VertexMath extends VectorMath
{
	...
	public static function linearGradientMatrix( p_oV0:Vertex, p_oV1:Vertex, p_oV2:Vertex,
		p_nR0:Number, p_nR1:Number, p_nR2:Number, p_oMatrix:Matrix ) : Matrix
	{
		var coef:Number = ( p_nR1 - p_nR0 ) / ( p_nR2 - p_nR0 );
		var p3x:Number = p_oV0.sx + coef * ( p_oV2.sx - p_oV0.sx );
		var p3y:Number = p_oV0.sy + coef * ( p_oV2.sy - p_oV0.sy );
		var p4x:Number = p_oV2.sx - p_oV0.sx;
		var p4y:Number = p_oV2.sy - p_oV0.sy;
		var p4len:Number = Math.sqrt( p4x * p4x + p4y * p4y );
		var d:Number = Math.atan2( p3x - p_oV1.sx, -( p3y - p_oV1.sy ) );
