...
class sandy.primitive.Plane3D extends Shape3D implements Primitive3D
{
	...
	private var _qH:Number; //uint
	private var _qV:Number; //uint
	 ...
	 * @see PrimitiveMode
	 */
	public function Plane3D( p_sName:String, p_nHeight:Number, p_nWidth:Number, p_nQualityH:Number/*uint*/,
							 p_nQualityV:Number/*uint*/, p_sType:String )
	{
		super( p_sName );
		_h = p_nHeight||100;
		_lg = p_nWidth||100;
