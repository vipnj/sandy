...
class sandy.math.Matrix4Math 
{
	...
	*/
	...
	{
		return		(m.n11 * m.n22 - m.n21 * m.n12) * (m.n33 * m.n44 - m.n42 * m.n34)- (m.n11 * m.n32 - m.n31 * m.n12) * (m.n23 * m.n44 - m.n41 * m.n24)
	...
	*/
	public static function getInverse( m:Matrix4 ):Matrix4
	{
		...
		return new Matrix4 (
		d * (m22 * (m33 * m44 - m43 * m34) + m32 * (m43 * m24 - m23 * m44) + m42 * (m23 * m34 - m33 * m24)),
		d * (m23 * (m31 * m44 - m41 * m34) + m33 * (m41 * m24 - m21 * m44) + m43 * (m21 * m34 - m31 * m24)),
		d * (m24 * (m31 * m42 - m41 * m32) + m34 * (m41 * m22 - m21 * m42) + m44 * (m21 * m32 - m31 * m22)),
		d * (m21 * (m42 * m33 - m32 * m43) + m31 * (m22 * m43 - m42 * m23) + m41 * (m32 * m23 - m22 * m33)),
		d * (m32 * (m13 * m44 - m43 * m14) + m42 * (m33 * m14 - m13 * m34) + m12 * (m43 * m34 - m33 * m44)),
		d * (m33 * (m11 * m44 - m41 * m14) + m43 * (m31 * m14 - m11 * m34) + m13 * (m41 * m34 - m31 * m44)),
		d * (m34 * (m11 * m42 - m41 * m12) + m44 * (m31 * m12 - m11 * m32) + m14 * (m41 * m32 - m31 * m42)),
		d * (m31 * (m42 * m13 - m12 * m43) + m41 * (m12 * m33 - m32 * m13) + m11 * (m32 * m43 - m42 * m33)),
		d * (m42 * (m13 * m24 - m23 * m14) + m12 * (m23 * m44 - m43 * m24) + m22 * (m43 * m14 - m13 * m44)),
		d * (m43 * (m11 * m24 - m21 * m14) + m13 * (m21 * m44 - m41 * m24) + m23 * (m41 * m14 - m11 * m44)),
		d * (m44 * (m11 * m22 - m21 * m12) + m14 * (m21 * m42 - m41 * m22) + m24 * (m41 * m12 - m11 * m42)),
		d * (m41 * (m22 * m13 - m12 * m23) + m11 * (m42 * m23 - m22 * m43) + m21 * (m12 * m43 - m42 * m13)),
		d * (m12 * (m33 * m24 - m23 * m34) + m22 * (m13 * m34 - m33 * m14) + m32 * (m23 * m14 - m13 * m24)),
		d * (m13 * (m31 * m24 - m21 * m34) + m23 * (m11 * m34 - m31 * m14) + m33 * (m21 * m14 - m11 * m24)),
		d * (m14 * (m31 * m22 - m21 * m32) + m24 * (m11 * m32 - m31 * m12) + m34 * (m21 * m12 - m11 * m22)),
		d * (m11 * (m22 * m33 - m32 * m23) + m21 * (m32 * m13 - m12 * m33) + m31 * (m12 * m23 - m22 * m13))
		);
	}
