package demos
{
	...
	public class OutlineDemo extends Sprite
	{
		...
		private function createScene():Group
		{
			...
			box = new Box( "box",60, 60, 60, PrimitiveMode.TRI, 1 );
			...
			var polygon:Polygon = box.aPolygons[ Box.FACE_FRONT ];
			box.enableEvents = true;
			polygon.addEventListener( MouseEvent.MOUSE_OVER, onMouseOver );
	    ...
	    private function onMouseOver( pEvt:Shape3DEvent ):void
	    {
	        trace( pEvt );
	    }
