package examples
{
	...
	public class CylinderExample extends BasicExample
	{
		...
		private function createScene( bg:Group ):void
		{
			...
			var translation1:Transform3D = new Transform3D();
			translation1.translate( 0, 0, 300 );
			tg1.setTransform( translation1 );
			
			var translation2:Transform3D = new Transform3D();
			
			
			//translation2.translate( 50, -110, 50 );
			translation2.rotAxis (new Vector (83, 100, 41), 90);	
			//tg2.setTransform( translation2 );
			
		
			tg2.setTransform( rot_int );
			*/
			...
			var box:Object3D = new Box( 100, 100, 100, "tri", 1);
			//var o:Object3D = new Sphere( 130, 13, 'tri' );
			//var o1:Object3D = new Sphere( 60, 15, 'tri' );
			//var o1:Object3D = new Sphere( 50, 3, 'tri' );
			//var o2:Object3D = new Sphere( 50, 5, 'tri' );
			//var o:Sprite2D = new Sprite2D();
			//var o:Object3D = new Cylinder( 100, 20, 9, 'tri' );
			var o1:Object3D = new Cylinder( 20, 120, 25, 'tri' );
			//var o:Object3D = new Hedra( 100, 20, 7, 'tri' );
