...
package sandy.core.data {
	...
	*/
	public class AnimationData
	{
		...
		*/
		public function addElement( idFrame:int, idVertex:int, x:Number, y:Number, z:Number ):void
		{
		...
		*/
		public function animate( o:Object3D, idFrame:int )
		{
			var i:int,l:int;
			var v:Vertex;
			var p:Object;
			var aV:Array = o.aPoints;
			var a:Array = _aFrames[ int(idFrame) ];
			//
			if( (l = a.length) )
			{
				for( i = 0; i < l; i++ )
