 ...
 * 
 * <p>Commands are named <strong>state-less</strong> when they can work
 * only from the passed-in event in the <code>execute</code> method without
 * having to define any parameters in the constructor.</p>
 * 
 * <p>Commands can be asynchronous by implementing the <code>ASyncCommand</code>
 * interface.</p>
 * 
...
interface Command 
{
	 ...
	 * 
	 * <p>Stateless commands may use the passed-in event object
	 ...
	 * @throws UnreachableDataException Stateless command use the passed-in event
