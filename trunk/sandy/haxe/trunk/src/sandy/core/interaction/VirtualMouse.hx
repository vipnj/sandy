...
**************************************************************************** */	
	public function interactWithTexture(  p_oPoly : Polygon, p_uvTexture : UVCoord, p_event : Event ) : Void
	{
		...
		{	
			...
			_lastEvent = new MouseEvent(MouseEvent.MOUSE_OVER, true, false, currentTargetLocal.x, currentTargetLocal.y, m_ioOldTarget, untyped( p_event.ctrlKey ), untyped( p_event.altKey ), untyped( p_event.shiftKey ), untyped( p_event.buttonDown ), untyped( p_event.delta ));
			currentTarget.dispatchEvent(_lastEvent);
			dispatchEvent(_lastEvent);
			// rolls do not propagate
			_lastEvent = new MouseEvent( MouseEvent.ROLL_OVER, false, false, currentTargetLocal.x, currentTargetLocal.y, m_ioOldTarget, untyped( p_event.ctrlKey ), untyped( p_event.altKey ), untyped( p_event.shiftKey ), untyped( p_event.buttonDown ), untyped( p_event.delta ));
			currentTarget.dispatchEvent(_lastEvent);
			dispatchEvent(_lastEvent);
		}
